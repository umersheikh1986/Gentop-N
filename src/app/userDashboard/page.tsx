...
//   return (
//     <section className="  ">
//       <div className="relative mt-60  mx-auto w-full grid-cols-2  justify-center gap-x-5 md:grid md:justify-between">
//         {/* User Details */}
...
//                       {/* {user?.[3] ? UseFormatEtherNumber(user?.[3]) : 0} */}1
//                     </h1>
...
// Define the User type (you might already have this in your project)
type User = {
  Id: number;
  DirectRefs: number;
  ...
  return (
    <section className="">
      <div className="relative mt-60 mx-auto w-full grid-cols-2 justify-center gap-x-5 md:grid md:justify-between">
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <div>
                    <div>
                      <h1 className="text-[20px] text-[#eeeeee]">
                        ID {user ? String(user.Id) : "Loading..."}
                      </h1>
                    </div>
                    <div className="mt-5 flex items-center justify-end text-[18px] text-[#eeeeee]">
                      <h1 className="mr-2">
                        {user ? String(user.DirectRefs) : "Loading..."}
                      </h1>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                ...
                <div className="mt-5 flex items-center justify-between text-[#eeeeee]">
                  ...
                  <div className="flex items-center">
                    <h1 className="mr-2 text-[16px]">1</h1>
                    <img src="/Dai.png" alt="" className="h-6 w-6" />
                  </div>
                </div>
                ...
                <div className="mt-4 flex justify-between gap-x-8">
                  <h1 className="font-san text-[16px] text-[#eeeeee]">
                    Your Link
                  </h1>
                  <CopyToClipboardButton text={affiliateLink} />
                </div>
                <div className="mt-4 flex items-center justify-between">
                  <h1 className="text-[16px] text-[#eeeeee]">
                    {affiliateLink}
                  </h1>
                </div>
              </div>
        ...
        {/* Users Info or Statistics */}
        <div className="flex w-full flex-col gap-5">
          <Statistics usersIsLoading={usersIsLoading} />
        </div>
      </div>
    </section>
  );
